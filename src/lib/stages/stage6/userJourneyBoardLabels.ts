...
export const JOURNEY_BOARD_PLACEHOLDERS = {
  ...
  aiZoneDrop: "진입하면 AI가 리서치 카드를 분석해 채워요. 카드를 놓거나 항목 추가로 보완하세요",
  aiTextPlaceholder: "내용을 입력하세요",
  aiAutoFilling: "AI가 리서치 카드를 분석해 채우는 중…",
  aiEntryAdd: "항목 추가",
  aiEntryRemove: "항목 삭제",
  ...
  feelingDrop: "사용자 행동·Pain point를 채우면 감정이 자동으로 그려져요",
  feelingDropActive: "여기에 놓기",
  feelingCurveEmpty: "사용자 행동·Pain point를 채우면 감정이 자동으로 그려져요",

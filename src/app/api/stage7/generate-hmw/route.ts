...
- 잠재 니즈에 있는 「어떠한/어떻게」 수식(전문적인, 쉽게, 한눈에, 효율적으로 등)은 HMW에도 살려 아이디어가 더 구체적으로 열리게 할 것
- 솔루션·기능·앱 이름 암시 금지
- 잠재 니즈를 그대로 복사하지 말 것
- JSON만 출력. 마크다운·설명 없음

few-shot 예:
니즈: "놓친 매출을 파악하기 위해서, 실시간 재고 현황을 한눈에 알고 싶다"
→ amp_up: "어떻게 하면 놓친 매출을 파악하기 위해 실시간 재고 변화를 즐겁게 한눈에 확인하는 습관으로 만들 수 있을까?"

...
export function IdeaGridCoachPanel({
  ...
  const chatContext = useMemo(
    () => ({
      ...
      stageBehaviorNote:
        "8단계 아이디어 펼치기: 핵심 니즈 기반 HMW로 칸을 채우고 quantity-first로 아이디어를 펼칩니다. 새 아이디어 화면에서는 HMW에 맞닿은 출시 사례를 영감용으로만 소개하며, 사용자 제목·설명을 대신 채우지 않습니다. 막히면 SCAMPER·원리 카드·팀 관점 자극을 쓰고, 칸을 비우면 아이디어 은행에 보류합니다. 더 필요하면 다음 사분면 니즈로 HMW를 추가할 수 있습니다. AI 스케치는 참고 사례일 뿐 사용자 스케치를 덮지 않습니다.",
    }),
